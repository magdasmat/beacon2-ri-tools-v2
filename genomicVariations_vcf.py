...
def generate(dict_properties, args):
    ...
    for vcf_filename in glob.glob(args.input):
        ...
        if args.refGenome:
            refGen = args.refGenome
            print("Reference genome provided by user: {} for file: {}".format(refGen, vcf_filename))
        else:
...
parser.add_argument('-rg', '--refGenome', default=None, choices=['GRCh37', 'GRCh38'], help='Reference genome (skips refgenDetector when provided)')
